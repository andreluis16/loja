...
<html>
    <head>
        ...
        <link href="{$GET_TEMPLATE}/tema/contacts/contact.css" rel="stylesheet" type="text/css"/>
        ...
        <script src="{$GET_TEMPLATE}/tema/js/bootstrap.min.js" type="text/javascript"></script>
         <script src="{$GET_TEMPLATE}/tema/contacts/contact.js" type="text/javascript"></script>
    ...
    <body>  
        ...
        <div class="container-fluid">
            ...
            <div class="row" id="topo">
                ...
                <div class="imagem" >
                <img class="img-logo" src="{$GET_TEMPLATE}/images/logo.png" alt=""> 
                    ...
                    <div class="container">
                        ...
                        <div class="collapse navbar-collapse" id="navbar">
                            <ul class="nav navbar-nav">
                               ...
                               <li><a href="{$PAGE_PRODUCTS}"><i class="glyphicon glyphicon-tag"></i> Produtos </a> </li>
                                <li><a href="{$PAGE_MYACCOUNT}"><i class="glyphicon glyphicon-user"></i> Minha Conta </a> </li>
                                <li><a href="{$PAGE_CART}"><i class="glyphicon glyphicon-shopping-cart"></i> Carrinho </a> </li>
                                <li><a href="{$PAGE_CONTACT}" ><i class="glyphicon glyphicon-envelope"></i> Contato </a> </li>
